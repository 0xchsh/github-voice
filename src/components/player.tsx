...
export function Player() {
  ...
  return (
    <div suppressHydrationWarning className="shrink-0 border-t border-border bg-card">
      {/* Mobile layout */}
      <div className="flex md:hidden items-center px-3 gap-3 h-16">
        {episode ? thumbnail : <div className="size-9 shrink-0 rounded-lg bg-muted" />}
